...
const MainHeader = () => {
  ...
  return (
    <div>
      <span className="font-Josefin text-40 leading-10 text-white font-bold absolute top-[4.5rem] left-[28.5rem]  z-50 xlg:left-[42.5rem] 2xl:left-[31rem]">
        T O D O
      </span>
      <div onClick={() => setTheme(colorTheme)}>
        {colorTheme === "light" ? (
          <img
            className="absolute top-[4.8rem] right-[28rem] z-50 xlg:right-[42.5rem] 2xl:right-[31rem]"
            src={iconPathDark}
      ...
      {colorTheme === "dark" ? (
        <img
          className="bg-gradient-to-r from-purple-600  to-blue-500 z-2   relative xlg:w-screen xlg:h-[325px] 2xl:w-screen  "
          src={lightImgPath}
